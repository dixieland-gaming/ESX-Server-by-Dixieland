        ...
        options = {
                ...
                onSelect = function()
                    ...
                    for i = 1, #Config.Campfire.items do
                        ...
                        options[#options + 1] = {
                            ...
                            metadata = metadata,
                            onSelect = function()
                                local hasItems = lib.callback.await('dxl_hunting:hasItems', false, item.require)
                                ...
                                then
                                    ...
                                    TriggerServerEvent("dxl_hunting:cookItem", data)
                                end
                            end
                        }
                    end
            ...
            },
            {
                ...
                onSelect = function()
                    ...
                    TriggerServerEvent("dxl_hunting:takeCampfire", data)
...
RegisterNetEvent("dxl_hunting:useCampfire", useCampFire)
