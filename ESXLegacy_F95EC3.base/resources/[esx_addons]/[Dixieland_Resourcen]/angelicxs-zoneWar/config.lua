...
Config.QBCoreUseGangs = false                -- If true and Config.UseQBCore = true, will use QBCore gang playerdata

Config.QBInput = false						-- Use QB-Input [https://github.com/qbcore-framework/qb-input]
Config.QBMenu = false						-- Use QB-Menu [https://github.com/qbcore-framework/qb-menu]
Config.OXLib = true						-- Use the OX_lib (Ignored if Config.QBInput = true) [https://github.com/overextended/ox_lib]  !! must add shared_script '@ox_lib/init.lua' and lua54 'yes' to fxmanifest!!
