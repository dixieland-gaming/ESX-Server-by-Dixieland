...
RegisterNetEvent('dxl_RecylceJob:CustomNotify')
AddEventHandler('dxl_RecylceJob:CustomNotify', function(message, type)
...
Config.AccountMoney = 'money'                -- What type of money they will get ('money', 'cash', 'bank' etc.)
