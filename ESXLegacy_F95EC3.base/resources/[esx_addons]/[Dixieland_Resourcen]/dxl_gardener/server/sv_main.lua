ESX.RegisterServerCallback('dxl_gardening:callback:checkJobStatistics', function(source, cb)
...
RegisterNetEvent('dxl_gardening:server:redeemPoints', function(collectedPoints)
    local xPlayer = ESX.GetPlayerFromId(source)
