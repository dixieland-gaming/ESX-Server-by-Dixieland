...
RegisterNetEvent('dxl_gang:CustomNotify')
AddEventHandler('dxl_gang:CustomNotify', function(message, type)
...
-- Configuration
Config.UseAddOnGang = true					-- If true must add database table dxl_gangterritorylist, allows players to make own gangs.
