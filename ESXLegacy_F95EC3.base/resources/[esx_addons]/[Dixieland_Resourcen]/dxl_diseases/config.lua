...
RegisterNetEvent('dxl_MedicalDiseases:CustomNotify')
AddEventHandler('dxl_MedicalDiseases:CustomNotify', function(message, type)
...
Config.IllnessChance = 10		    -- % Chance to get sick
