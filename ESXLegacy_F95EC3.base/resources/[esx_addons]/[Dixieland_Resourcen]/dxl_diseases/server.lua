...
RegisterNetEvent('dxl_MedicalDiseases:CommandHeal', function(player)
    if player then
        TriggerEvent('dxl_MedicalDiseases:CureDisease', player, 'all')
    end
end)

RegisterNetEvent('dxl_MedicalDiseases:CureDisease', function(source, type)
    TriggerClientEvent('dxl_MedicalDiseases:CureIllness', source, 'allowed', type)
end)
