...
Config.UseESX = true						-- Use ESX Framework (GO TO FXMANIFEST AND UNCOMMENT '@es_extended/imports.lua' )
...
RegisterNetEvent('dxl_BankTruck:CustomNotify')
AddEventHandler('dxl_BankTruck:CustomNotify', function(message, type)
...
Config.LEOJobName = {'bcso'} 		-- Job name of law enforcement officers
RegisterNetEvent('dxl_BankTruck:PoliceAlert')
AddEventHandler('dxl_BankTruck:PoliceAlert', function(coords)
...
Config.MoneyType = 'money'                   -- If Config.UseMoneyNotItem = true, what acccount the money goes into.

Config.RareLootChance = 1					-- Chance to receive rare item in addition to normal reward
Config.RareLootItem = 'diamond'	-- Name of rare loot item
