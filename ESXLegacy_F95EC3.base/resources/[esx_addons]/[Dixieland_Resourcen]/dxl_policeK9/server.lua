...
if Config.UseESX then
    ESX.RegisterServerCallback('dxl_k9script:server:search:ESX', function(source, cb, target)
        local src = target
	...
	ESX.RegisterServerCallback('dxl_k9script:server:searchcar:ESX', function(source, cb, plate)
...
elseif Config.UseQBCore then
    QBCore.Functions.CreateCallback('dxl_k9script:server:search:QBCore', function(source, cb, target)
        local src = target
    ...
    QBCore.Functions.CreateCallback('dxl_k9script:server:searchcar:QBCore', function(source, cb, plate)
        print('Vehicle '..plate..' is being searched by a dog.')
