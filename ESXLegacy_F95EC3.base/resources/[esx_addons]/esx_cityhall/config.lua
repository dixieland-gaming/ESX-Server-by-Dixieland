...
Config.General = {
    ...
    position = {
        coords = vector3(-544.984619, -204.329666, 38.210205), -- The position of the NPC and the marker (x, y, z) /// If you want to use the NPC and the marker, you need to set enable to true
